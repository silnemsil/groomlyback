...
INSERT INTO groomly.procedure (id, name, description, status) VALUES (default, 'lõikus', e'masina ja kääridega lõikus', 'A');
INSERT INTO groomly.procedure (id, name, description, status) VALUES (default, 'pesemine', e'pesemine, pulstunud karva kammimine', 'A');
INSERT INTO groomly.procedure (id, name, description, status) VALUES (default, 'hügieeni hooldus', e'küünte lõikus, kõrvade ja silmade puhastamine', 'A');
INSERT INTO groomly.procedure (id, name, description, status) VALUES (default, 'täispakett', 'hügieeni hooldus, pesemine, lõikus', 'A');
...
INSERT INTO groomly.groomer_procedure (id, groomer_id, procedure_id, price) VALUES (default, 1, 3, 20.00);
INSERT INTO groomly.groomer_procedure (id, groomer_id, procedure_id, price) VALUES (default, 3, 1, 100.00);
